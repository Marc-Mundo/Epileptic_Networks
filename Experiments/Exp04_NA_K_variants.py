...
def createRun(nps_tuple, cell_to_mod):
    # t0 = time.time()
...
def run_many(variant: tuple):
    # sodium = variant
    cond, channel, pop = variant
    mods = {
        "0.5": 0.5,
        "NA_0.6": 0.6,
        "NA_0.7": 0.7,
    ...
    # data/Pyr/NA/0.5/*.pkl
    data_path = f"../data/{pop}/{channel}/{cond}/{variant}/"
...
# for pop in [Pyr, Bwb, OLM]
# for cond in conditions:    <--- this part you can parallelize
# [conditions] <- map them onto a process
